										...
										<div class="row gtr-200">
											...
											<div class="col-6 col-12-medium">
												...
												<!-- Image -->
													...
													<h4>Fit</h4>
													<span class="image fit"><img src="${path}/resources/images/pic11.jpg" alt="" /></span>
													<div class="box alt">
														<div class="row gtr-50 gtr-uniform">
															<div class="col-4"><span class="image fit"><img src="${path}/resources/images/pic01.jpg" alt="" /></span></div>
															<div class="col-4"><span class="image fit"><img src="${path}/resources/images/pic02.jpg" alt="" /></span></div>
															<div class="col-4"><span class="image fit"><img src="${path}/resources/images/pic03.jpg" alt="" /></span></div>
															<!-- Break -->
															<div class="col-4"><span class="image fit"><img src="${path}/resources/images/pic03.jpg" alt="" /></span></div>
															<div class="col-4"><span class="image fit"><img src="${path}/resources/images/pic01.jpg" alt="" /></span></div>
															<div class="col-4"><span class="image fit"><img src="${path}/resources/images/pic02.jpg" alt="" /></span></div>
